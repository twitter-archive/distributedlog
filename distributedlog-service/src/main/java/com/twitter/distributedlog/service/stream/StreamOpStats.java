...
public class StreamOpStats {
    ...
    public StreamOpStats(StatsLogger statsLogger, DistributedLogConfiguration conf) {
        ...
        boolean perStreamStatsEnabled = conf.getBoolean("server_enable_perstream_stat", true);
