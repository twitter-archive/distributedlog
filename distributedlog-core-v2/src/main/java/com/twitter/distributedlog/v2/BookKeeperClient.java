...
import com.twitter.distributedlog.v2.ZooKeeperClient.Credentials;
import com.twitter.distributedlog.v2.ZooKeeperClient.DigestCredentials;
import com.twitter.distributedlog.v2.net.TwitterDNSResolverForRacks;
import com.twitter.distributedlog.v2.net.TwitterDNSResolverForRows;
import com.twitter.distributedlog.v2.util.ConfUtils;
    ...
    private synchronized void initialize() throws IOException {
        ...
        if (ownZK) {
            LOG.info("BookKeeper Client created {} with its own ZK Client : ledgersPath = {}, numRetries = {}, " +
                    "sessionTimeout = {}, backoff = {}, maxBackoff = {}, registerExpirationHandler = {}",
